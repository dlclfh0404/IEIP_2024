...
create table member_tbl_02 (
	...
	grade char(1),
	city char(2),
	constraints mbr_pk primary key(custno)
);
...
create table money_tbl_02 (
	...
	pcode varchar2(4),
	sdate date,
	constraints mon_pk primary key(custno, salenol),
	constraints mon_mbr_fk foreign key(custno) references member_tbl_02(custno)
);
